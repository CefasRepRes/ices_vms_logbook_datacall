...
SELECT DISTINCT
  ...
  CAST ( iFV.DEPARTURE_DATE_TIME AS DATE)  +  CAST (iFV.DEPARTURE_DATE_TIME AS TIME) as FT_DDATIM, 
  ...
  CAST( iFV.RETURN_DATE_TIME AS DATE) +  CAST( iFV.RETURN_DATE_TIME AS TIME)  as FT_LDATIM,
